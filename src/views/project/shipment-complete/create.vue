  ...
  <div class="create-container">
    ...
    <el-form ref="projectForm" :model="projectForm" :rules="rules" label-width="100px" class="project-form">
      ...
      <el-row :gutter="24">
        ...
        <el-col :xs="18" :sm="8" :md="8" :lg="6">
          <el-form-item label="实际发货日期" prop="deliverdDate" label-width="110px">
...
import { addShipmentComplete } from '@/api/shipment-complete'
    ...
    submitForm(formName) {
      this.$refs[formName].validate((valid) => {
        if (valid) {
          ...
          addShipmentComplete(formData).then(response => {
