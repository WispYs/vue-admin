<template>
  <div class="filter-bar">
    ...
    <div class="filter-bar__item">
      ...
      <el-button type="primary" size="medium" @click="$router.push({name: 'CompleteCreate'})">新增项目</el-button>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    __initFilter() {
      ...
      this.deliverEndTime = ''
      this.deliverdDate = ''
      this.deliverdStartDate = ''
      this.deliverdEndDate = ''
    },
    ...
    __getFilter() {
      return {
        ...
        deliverdStartDate: this.deliverdDate[0] ? this.deliverdDate[1] : '',
        deliverdEndDate: this.deliverdDate[0] ? this.deliverdDate[1] : ''
      }
    },
    search() {
