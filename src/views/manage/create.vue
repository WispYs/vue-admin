  ...
  <div class="create-container">
    <el-form ref="ruleForm" :model="ruleForm" :rules="rules" label-width="100px" class="demo-ruleForm">
      ...
      <el-row :gutter="24">
        ...
        <el-col :xs="18" :sm="8" :md="8" :lg="6">
          <el-form-item label="项目工程师" prop="engineer">
            <el-input v-model="ruleForm.engineer" />
          </el-form-item>
        </el-col>
        <el-col :xs="18" :sm="8" :md="8" :lg="6">
      ...
      <el-row :gutter="24">
        <el-col :xs="18" :sm="8" :md="8" :lg="6">
          <el-form-item label="柜体数量" prop="cabinetNum">
            <el-input v-model.number="ruleForm.cabinetNum" />
          </el-form-item>
        </el-col>
        <el-col :xs="18" :sm="8" :md="8" :lg="6">
        ...
        <el-col :xs="18" :sm="8" :md="8" :lg="6">
          <el-form-item label="折算标准柜" prop="cabinetAverage">
            <el-input v-model="ruleForm.cabinetAverage" />
          </el-form-item>
        </el-col>
      </el-row>
      <el-row :gutter="24">
        <el-col :xs="18" :sm="8" :md="8" :lg="6">
          <el-form-item label="成套计划时间" prop="hours">
            <el-input v-model="ruleForm.hours">
        ...
        <el-col :xs="18" :sm="8" :md="8" :lg="6">
          <el-form-item label="成套剩余时间" prop="surplusHours">
            <el-input v-model="ruleForm.surplusHours">
              <template slot="append">天</template>
            </el-input>
          </el-form-item>
        </el-col>
      ...
      <el-row :gutter="24">
        <el-col :xs="24" :sm="12" :md="12" :lg="8">
          <el-form-item label="成套资料提交时间" label-width="140px" prop="dataSubmitTime">
            <el-date-picker v-model="ruleForm.dataSubmitTime" value-format="yyyy-MM-dd" type="date" placeholder="选择日期" style="width: 100%;" />
          </el-form-item>
        </el-col>
        <el-col :xs="24" :sm="12" :md="12" :lg="8">
          <el-form-item label="材料提货时间" label-width="140px" prop="dataPickupTime">
            <el-date-picker v-model="ruleForm.dataPickupTime" value-format="yyyy-MM-dd" type="date" placeholder="选择日期" style="width: 100%;" />
          </el-form-item>
        </el-col>
        <el-col :xs="24" :sm="12" :md="12" :lg="8">
          <el-form-item label="材料要求到货时间" label-width="140px" prop="dataPlanTime">
            <el-date-picker v-model="ruleForm.dataPlanTime" value-format="yyyy-MM-dd" type="date" placeholder="选择日期" style="width: 100%;" />
          </el-form-item>
        </el-col>
        <el-col :xs="24" :sm="12" :md="12" :lg="8">
          <el-form-item label="成套计划启动时间" label-width="140px" prop="planStartTime">
            <el-date-picker v-model="ruleForm.planStartTime" value-format="yyyy-MM-dd" type="date" placeholder="选择日期" style="width: 100%;" />
          </el-form-item>
        </el-col>
        <el-col :xs="24" :sm="12" :md="12" :lg="8">
          <el-form-item label="成套计划完成时间" label-width="140px" prop="planFinishTime">
            <el-date-picker v-model="ruleForm.planFinishTime" value-format="yyyy-MM-dd" type="date" placeholder="选择日期" style="width: 100%;" />
          </el-form-item>
        </el-col>
        <el-col :xs="24" :sm="12" :md="12" :lg="8">
          <el-form-item label="原计划发货时间" label-width="140px" prop="PlanDeliveryTime">
            <el-date-picker v-model="ruleForm.PlanDeliveryTime" value-format="yyyy-MM-dd" type="date" placeholder="选择日期" style="width: 100%;" />
          </el-form-item>
        </el-col>
      </el-row>
      <el-form-item label="反馈提货" prop="delivery">
        <el-switch v-model="ruleForm.pickFeedback" />
      </el-form-item>
      <el-form-item label="设计阶段：" prop="dStatusArr">
        <el-checkbox-group v-model="ruleForm.dStatusArr">
      ...
      <el-form-item label="生产阶段：" prop="pStatusArr">
        <el-checkbox-group v-model="ruleForm.pStatusArr">
      ...
      <el-form-item label="项目问题汇总" prop="issue">
        <el-input v-model="ruleForm.issue" type="textarea" :autosize="{ minRows: 3, maxRows: 6}" />
      </el-form-item>
      <el-form-item label="缺料反馈" prop="lackFeedback">
        <el-input v-model="ruleForm.lackFeedback" type="textarea" :autosize="{ minRows: 3, maxRows: 6}" />
      </el-form-item>
      <el-form-item>
